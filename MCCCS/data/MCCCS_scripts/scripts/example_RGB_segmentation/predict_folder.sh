...
echo -n "d"
$JAVA.ArffFromImageFileGenerator 3 2 "${dir}"

echo -n "e"
$WEKA weka.filters.supervised.attribute.AddClassification -i "${dir}/${dir}.arff" -serialized "$MODEL" -classification -remove-old-class -o "${dir}/result.arff" -c last
