...
public class Color_Transformer_2 implements PlugInFilter {
	...
	private float[] c1, c2, c3, c4; // Colour space values
	private int[] d1, d2, d3, d4; // Integer values for CMYK plates
	private String n1, n2, n3, n4; // Names for every layer on the stack
	...
	public void setUp(String RGBcolourspace, String targetColorSpace) {
