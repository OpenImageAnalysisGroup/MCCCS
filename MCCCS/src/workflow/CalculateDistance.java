...
/**
 * Calculate distance map float image. Modes: 0 - eucl. distance map X, 1 - eucl. distance map Y, 2 - eucl. distance map dist, 3 - euchl. distance map
 * degree*255/360.
 * 
 * @param mode
 *           0/1/2/3
